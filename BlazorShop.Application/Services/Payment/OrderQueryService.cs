        ...
        private async Task<IEnumerable<GetOrder>> MapWithUsersAsync(IEnumerable<Order> orders, IDictionary<Guid, string> nameMap)
        {
            ...
            foreach (var o in orders)
            {
                ...
                result.Add(new GetOrder
                {
                    ...
                    BaseTotalAmount = o.BaseTotalAmount,
                    ExchangeRate = o.ExchangeRate,
                    ExchangeRateProviderKey = o.ExchangeRateProviderKey,
                    ExchangeRateSource = o.ExchangeRateSource,
                    ExchangeRateEffectiveAtUtc = o.ExchangeRateEffectiveAtUtc,
                    ExchangeRateExpiresAtUtc = o.ExchangeRateExpiresAtUtc,
                    ...
                    Lines = o.Lines.Select(l => new GetOrderLine
                    {
                        ...
                        ConvertedUnitPrice = l.ConvertedUnitPrice,
                        PersistedLineTotal = l.LineTotal,
                        BaseLineTotal = l.BaseLineTotal,
