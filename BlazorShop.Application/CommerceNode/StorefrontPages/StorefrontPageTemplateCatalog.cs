namespace BlazorShop.Application.CommerceNode.StorefrontPages
{
    public static class StorefrontPageTemplateCatalog
    {
        ...
        [
            new("about", "About us", "about-us", "About us", true, StorefrontPageContentRules.FooterCompany, 100),
            ...
            new("terms_conditions", "Terms and conditions", "terms", "Terms and conditions", true, StorefrontPageContentRules.FooterLegal, 300),
            new("privacy_policy", "Privacy policy", "privacy", "Privacy policy", true, StorefrontPageContentRules.FooterLegal, 310),
