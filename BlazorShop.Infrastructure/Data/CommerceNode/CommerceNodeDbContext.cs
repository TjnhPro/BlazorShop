namespace BlazorShop.Infrastructure.Data.CommerceNode
{
    ...
    public sealed class CommerceNodeDbContext : IdentityDbContext<AppUser>
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<CommerceCustomerAddress>(entity =>
            {
            ...
            modelBuilder.Entity<PaymentAttemptAuditLog>(entity =>
            {
            ...
            modelBuilder.Entity<StoreEmailSettings>(entity =>
            {
                entity.ToTable("store_email_settings", table =>
                {
                    table.HasCheckConstraint(
                        "ck_store_email_settings_delivery_mode",
                        $"delivery_mode in ({SqlIn(StoreEmailDeliveryModes.All)})");
                    table.HasCheckConstraint(
            ...
            modelBuilder.Entity<StoreSecurityPrivacySettings>(entity =>
            {
            ...
            modelBuilder.Entity<StoreShippingSettings>(entity =>
            {
