namespace BlazorShop.Infrastructure.Data.ControlPlane
{
    ...
    public sealed class ControlPlanePaymentGateway : ControlPlaneCommerceGatewayBase, BlazorShop.Application.ControlPlane.CommerceGateway.Payments.IControlPlanePaymentGateway
    {
        public ControlPlanePaymentGateway(ICommerceNodeAdminGatewayTransport transport)
            : base(transport)
        {
        }
