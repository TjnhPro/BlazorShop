namespace BlazorShop.Infrastructure.Data.ControlPlane
{
    ...
    public sealed class ControlPlaneShippingGateway : ControlPlaneCommerceGatewayBase, BlazorShop.Application.ControlPlane.CommerceGateway.Shipping.IControlPlaneShippingGateway
    {
        public ControlPlaneShippingGateway(ICommerceNodeAdminGatewayTransport transport)
            : base(transport)
        {
        }
