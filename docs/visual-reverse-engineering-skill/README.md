...
Use `.\scripts\qa\run-storefront-builder-generated-proof.ps1 -ProofLevel Structure` for fast generated package/boundary proof. Use `-ProofLevel FoundationFunctional` before closure when fixture-backed generated browser behavior must be proven.
