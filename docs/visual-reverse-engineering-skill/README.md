...
The Phase 3D gate has no skip flags. Phase 3 overall is locally closed after this gate passed with a clean tree and the tested SHA equaled final `HEAD`; see `docs/qa/phase3d-final-closure.md` for the proof report.
