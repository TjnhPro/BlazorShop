...
Use `.\scripts\qa\run-storefront-builder-generated-proof.ps1 -ProofLevel Structure` for generated package/boundary proof. Use `-ProofLevel FoundationFunctionalFast` for PR-safe generated browser action proof. Use `-ProofLevel FoundationFunctionalFull` before release closure when fixture-backed generated browser behavior must be proven.
