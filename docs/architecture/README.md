...
- `BlazorShop.Storefront.Client`, `BlazorShop.Storefront.Runtime`, `BlazorShop.Storefront.Presentation`, and `BlazorShop.Storefront.Starter` are the active generated-storefront platform source surface. Presentation owns shared App/Routes/page services/BFF/SEO/media composition; V2, Starter, and generated storefronts provide host configuration, registered views, assets, copy, and visual output.
