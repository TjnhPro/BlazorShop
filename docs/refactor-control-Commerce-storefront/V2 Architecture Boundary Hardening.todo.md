...
- [x] Extract components only after code-behind split passes:
...
- [x] Do not introduce page-state interfaces unless a second consumer appears.
- [x] Preserve route, permissions, forms, validation, and service calls.
...
Phase 7D.2 focused verification:
