...
- [x] Record current Storefront page inventory:
  ...
  - [x] `Pages/Commerce/CartPage.razor`
  - [x] `Pages/Commerce/CheckoutPage.razor`
  - [x] `Pages/Commerce/PaymentSuccessPage.razor`
  - [x] `Pages/Commerce/PaymentCancelPage.razor`
  - [x] `Pages/Auth/SignInPage.razor`
  - [x] `Pages/Auth/RegisterPage.razor`
  - [x] `Pages/Auth/ForgotPasswordPage.razor`
  - [x] `Pages/Auth/ResetPasswordPage.razor`
...
- [ ] Create target folders:
  ...
  - [ ] `Pages/Ssr/Content`
  - [ ] `Pages/Ssr/System`
  - [ ] `Pages/Hybrid/Catalog`
  - [ ] `Pages/Hybrid/Commerce`
  - [ ] `Pages/WasmHost/Account`
- [ ] Move files mechanically without changing `@page` route declarations.
- [ ] Keep existing route names and URLs unchanged.
- [ ] Update namespaces/usings generated by the move only where required.
- [ ] Update route inventory tests to look at new paths.
- [ ] Update `docs/architecture/05-project-and-folder-guide.md` to describe the new render-ownership folders.
- [ ] Add a short `README.md` or comment-free documentation section explaining:
  - [ ] `Ssr` pages.
  - [ ] `Hybrid` pages.
  - [ ] `WasmHost` pages.
  - [ ] when a new page belongs in each folder.
- [ ] Do not refactor page internals in this phase.
...
- [ ] A developer can identify render ownership from the folder path.
- [ ] All public/private route URLs still work.
- [ ] The change is mechanical and separately reviewable.
...
- [ ] Commit 2: mechanical folder move to `Ssr`, `Hybrid`, and `WasmHost`.
