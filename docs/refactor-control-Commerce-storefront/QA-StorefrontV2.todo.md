...
- [x] Storefront account orders, order detail, receipt, and address pages render through local SSR account routes. 2026-07-17 Customer Identity Phase 6: Storefront V2 build passed; `StorefrontV2ApiClientTests` passed 22/22 and `StorefrontV2HostSmokeTests` passed 44/44.
