...
- [x] V2F7 focused build/tests passed. 2026-07-25: `dotnet build BlazorShop.sln` passed with known MessagePack/Browserslist warnings; focused `StorefrontCommerceFlowCutoverTests|StorefrontWasmRuntimeFoundationTests|SecurityPrivacyPhase1CsrfTests|StorefrontCheckout` passed 87/88 with 1 skipped.
