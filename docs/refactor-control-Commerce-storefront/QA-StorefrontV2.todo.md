...
- [x] Storefront V2 route pages are grouped by ownership without route URL changes. 2026-07-23 Phase 5: pages moved under `Pages/Catalog`, `Pages/Content`, `Pages/Commerce`, `Pages/Auth`, `Pages/Account`, and `Pages/System`; code-behind namespaces and source-reference tests were updated, and `docs/architecture/05-project-and-folder-guide.md` records the structure.
