...
- [~] Visible browser QA for product gallery thumbnail click, mobile strip layout, and broken-image detection remains pending. 2026-07-20: release checklist cases were added, but local V2 runtime could not be started because Docker Desktop engine was unavailable.
