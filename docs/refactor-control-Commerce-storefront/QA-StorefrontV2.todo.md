...
- [x] Account routes share a route shell without moving account behavior into the shell. 2026-07-23 Phase 4: `AccountPageShell` owns account layout/navigation/title slot, account pages keep `@page`, `noindex,nofollow`, session guard, antiforgery/API data load where applicable, and WASM component rendering; focused account/static tests passed 22/22.
