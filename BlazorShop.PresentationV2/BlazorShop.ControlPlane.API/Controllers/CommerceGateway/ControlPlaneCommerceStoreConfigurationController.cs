namespace BlazorShop.ControlPlane.API.Controllers
{
    ...
    public sealed class ControlPlaneCommerceStoreConfigurationController : ControlPlaneCommerceGatewayControllerBase
    {
        private readonly BlazorShop.Application.ControlPlane.CommerceGateway.StoreConfiguration.IControlPlaneStoreConfigurationGateway gateway;

        public ControlPlaneCommerceStoreConfigurationController(BlazorShop.Application.ControlPlane.CommerceGateway.StoreConfiguration.IControlPlaneStoreConfigurationGateway gateway)
        {
        ...
        {
            return ToActionResult(await this.gateway.GetRuntimeStoreAsync(storePublicId, cancellationToken));
        }
        ...
        public async Task<IActionResult> ActivateRuntimeStore(
            ...
            CancellationToken cancellationToken)
        {
            return ToActionResult(await this.gateway.ActivateRuntimeStoreAsync(
                storePublicId,
                runtimeStorePublicId,
                cancellationToken));
        }
        ...
        public async Task<IActionResult> DeactivateRuntimeStore(
            ...
            CancellationToken cancellationToken)
        {
            return ToActionResult(await this.gateway.DeactivateRuntimeStoreAsync(
                storePublicId,
                runtimeStorePublicId,
                cancellationToken));
        }
