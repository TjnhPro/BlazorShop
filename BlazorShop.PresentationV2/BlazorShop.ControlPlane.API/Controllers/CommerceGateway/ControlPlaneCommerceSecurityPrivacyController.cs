namespace BlazorShop.ControlPlane.API.Controllers
{
    ...
    public sealed class ControlPlaneCommerceSecurityPrivacyController : ControlPlaneCommerceGatewayControllerBase
    {
        private readonly BlazorShop.Application.ControlPlane.CommerceGateway.SecurityPrivacy.IControlPlaneSecurityPrivacyGateway gateway;

        public ControlPlaneCommerceSecurityPrivacyController(BlazorShop.Application.ControlPlane.CommerceGateway.SecurityPrivacy.IControlPlaneSecurityPrivacyGateway gateway)
        {
        ...
        {
            return ToActionResult(await this.gateway.GetSecurityPrivacySettingsAsync(storePublicId, cancellationToken));
        }
