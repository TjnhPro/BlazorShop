namespace BlazorShop.ControlPlane.Web.Services.Commerce
{
    ...
    using BlazorShop.Domain.Contracts;
        ...
        public sealed class ControlPlanePaymentClient : ControlPlaneCommerceClientBase, IControlPlanePaymentClient
    {
        public ControlPlanePaymentClient(IControlPlaneApiClient apiClient)
            : base(apiClient)
        {
        }
