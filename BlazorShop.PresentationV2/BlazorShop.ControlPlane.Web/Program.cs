...
using BlazorShop.ControlPlane.Web.Services.Catalog;
using BlazorShop.ControlPlane.Web.Services.Commerce;
...
builder.Services.AddScoped<IControlPlaneCatalogClient, ControlPlaneCatalogClient>();
builder.Services.AddScoped<IControlPlaneProductClient, ControlPlaneProductClient>();
builder.Services.AddScoped<IControlPlaneProductImportClient, ControlPlaneProductImportClient>();
builder.Services.AddScoped<IControlPlaneCategoryClient, ControlPlaneCategoryClient>();
builder.Services.AddScoped<IControlPlaneMediaClient, ControlPlaneMediaClient>();
builder.Services.AddScoped<IControlPlaneOrderClient, ControlPlaneOrderClient>();
builder.Services.AddScoped<IControlPlaneContentClient, ControlPlaneContentClient>();
builder.Services.AddScoped<IControlPlaneNavigationClient, ControlPlaneNavigationClient>();
builder.Services.AddScoped<IControlPlaneCurrencyClient, ControlPlaneCurrencyClient>();
builder.Services.AddScoped<IControlPlanePaymentClient, ControlPlanePaymentClient>();
builder.Services.AddScoped<IControlPlaneShippingClient, ControlPlaneShippingClient>();
builder.Services.AddScoped<IControlPlaneSecurityPrivacyClient, ControlPlaneSecurityPrivacyClient>();
builder.Services.AddScoped<IControlPlaneMessageClient, ControlPlaneMessageClient>();
builder.Services.AddScoped<IControlPlaneSeoClient, ControlPlaneSeoClient>();
