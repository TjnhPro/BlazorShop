...
public sealed record StorefrontPageContract(
    ...
    IReadOnlyList<string> RequiredSlotIds,
    IReadOnlyList<string> OptionalSlotIds,
    IReadOnlyList<string> RepeatableSlotIds,
    IReadOnlyList<string> AllowedAdditionalSlotIds,
    IReadOnlyList<string> ForbiddenBehaviorIds,
    IReadOnlyList<string> ProhibitedBehavior,
