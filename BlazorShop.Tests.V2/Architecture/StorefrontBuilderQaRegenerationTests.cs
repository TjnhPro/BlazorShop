    ...
    public sealed class StorefrontBuilderQaRegenerationTests
    {
        ...
        public void CreateGeneratorHardening_UsesNormalizationStagingAndAtomicReplacement()
        {
            ...
            foreach (var marker in new[]
            {
                ...
                "DemoPlan",
                "plan-only",
                "Manual artifact output root should be allowed under artifacts/storefront-builder.",
                "SFB-PROJECT-001",
                "SFB-PROJECT-002",
                "SFB-PROJECT-010",
                "SFB-PROJECT-011",
        ...
        public void IdempotentRegeneration_TracksHashesCommandsAndManualEditConflicts()
        {
            ...
            foreach (var marker in new[]
            {
                ...
                "SkipIdempotency",
                "SFB_KEEP_REGENERATION_CANDIDATE_ARTIFACTS",
                "SFB_DROP_CANDIDATE_FILE_PATHS",
            ...
            foreach (var marker in new[]
            {
                "HomePage was not updated by page-scope regeneration.",
                "Page-scope regeneration touched ProductPage.",
                "ProductSummaryCard was not updated by component-scope regeneration.",
                "Component-scope regeneration touched ProductPage.",
