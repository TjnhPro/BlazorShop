namespace BlazorShop.Tests.Architecture
{
    ...
    public sealed class V2ProductionReadinessTests
    {
        ...
        public void Phase3_CiWorkflow_UsesV2ReleaseGateAndLegacyCompatibility()
        {
            ...
            Assert.DoesNotContain("legacy-compatibility:", workflow, StringComparison.Ordinal);
            ...
            Assert.DoesNotContain("BlazorShop.Presentation/", workflow, StringComparison.Ordinal);
            Assert.DoesNotContain("BlazorShop.Tests/BlazorShop.Tests.csproj", workflow, StringComparison.Ordinal);
        }
        ...
        [Fact]
        public void Phase3_V2TestProject_OwnsCoreCommerceAndControlPlaneTests()
        {
            var v2TestProject = ReadRepositoryFile("BlazorShop.Tests.V2/BlazorShop.Tests.V2.csproj");
            var applicationCommerceNodeTests = EnumerateFiles("BlazorShop.Tests.V2/Application/CommerceNode", "*.cs").ToArray();
            var infrastructureCommerceNodeTests = EnumerateFiles("BlazorShop.Tests.V2/Infrastructure/CommerceNode", "*.cs").ToArray();
            var infrastructureControlPlaneTests = EnumerateFiles("BlazorShop.Tests.V2/Infrastructure/ControlPlane", "*.cs").ToArray();
            ...
            Assert.Contains(
                "BlazorShop.Tests.V2/Application/CommerceNode/StorefrontCheckoutServiceTests.cs",
                applicationCommerceNodeTests.Select(ToRepositoryRelativePath));
            Assert.Contains(
                "BlazorShop.Tests.V2/Infrastructure/CommerceNode/CommerceNodeDbContextModelTests.cs",
                infrastructureCommerceNodeTests.Select(ToRepositoryRelativePath));
            Assert.Contains(
                "BlazorShop.Tests.V2/Infrastructure/ControlPlane/ControlPlaneDbContextModelTests.cs",
        ...
        {
            var storefrontOpenApiTests = ReadRepositoryFile("BlazorShop.Tests.V2/PresentationV2/CommerceNode/CommerceNodeStorefrontOpenApiContractTests.cs");
